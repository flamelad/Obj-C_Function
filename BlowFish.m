...
//    
//    NSString *keyAscii = @"5399602753996027";
//    NSString *ivAscii = @"53996027";
//    
...
// 傳入的字串會以blowfish機制加密，並回傳一串加密好的字串

-(id) encode:(NSString *)str{
...
// 傳入已經被PHP加密過的字串，回傳是解密後的byte形態資料
...
-(NSData *)crypt:(uint32_t) operation cinpherText:(NSData *) data{
    NSData *keyAscii = [@"5399602753996027" dataUsingEncoding:NSUTF8StringEncoding];
    NSData *ivAscii = [@"53996027" dataUsingEncoding:NSUTF8StringEncoding];
